...
if(!isset($_SESSION["login"])){
  header("Location: Login-Adam.php");
}
?>
...
<body>
  <header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary py-3">
      <div class="container">
        ...
        <div class="add-car">
            <a href="Add-Adam.php" class="btn btn-light text-primary">Add Car</a>
      </div>
    </nav>
  </header>
  ...
  <main>
    <div class="container mt-5">
      <div class="judul">
        <h2>My Showroom</h2>
        <p>List Showroom Adam-1202204311</p>
      </div>
      <div class="row gap-4">
          ...
          <div class="col-md-5">
            <div class="card">
              ...
              <div class="row justify-content-center gap-4">
                <div class="col-md-5"><a href="Detail-Adam.php?id=<?=$data['id_mobil']?>" class="btn btn-primary rounded-pill w-100">Detail</a></div>
